...
class PitchModelTest(unittest.TestCase):
    def setUp(self):
        self.user_Ray = User(username = 'Preston',password = 'banana', email = 'prestontookip@gmail.com')
        self.new_pitch = Pitch(id=1,pitch_title='Test',pitch_content='This is a test pitch',category="interview",user = self.user_Ray,likes=0,dislikes=0)
